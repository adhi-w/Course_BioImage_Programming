...
public class HarrisCornerDetector {
	...
	public void findCorners(){
		...
		ImagePlus AImp = new ImagePlus("A",A);
		ImagePlus BImp = new ImagePlus("B",B);
		ImagePlus CImp = new ImagePlus("C",C);
		ImagePlus QImp = new ImagePlus("Q",Q);
	...
	List<Corner> cleanupCorners(List<Corner> corners){
		// corners is assumed to be sorted by descending q
	...
	static FloatProcessor convolve1h (FloatProcessor I, float[] h) {
	...
	static FloatProcessor convolve1v (FloatProcessor I, float[] h) {
		Convolver conv = new Convolver();
		conv.setNormalize(false);
	...
	static FloatProcessor convolve2 (FloatProcessor I, float[] h) {
		convolve1h(I,h);
		convolve1v(I,h);
		return I;
	}
	
	static FloatProcessor sqr (FloatProcessor I) {
		I.sqr();
		return I;
	}
	
	static FloatProcessor mult (FloatProcessor I1, FloatProcessor I2) {
		I1.copyBits(I2, 0, 0, Blitter.MULTIPLY);
		return I1;
	}
	
//	static FloatProcessor localMax (FloatProcessor fp) {
